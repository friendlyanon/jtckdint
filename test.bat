...
call :build -Os -fsanitize=undefined -fsanitize-undefined-trap-on-error -std=c++14 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
call :build -Os -fsanitize=undefined -fsanitize-undefined-trap-on-error -pedantic-errors -std=c++14
if not %errorlevel% == 0 exit /b %errorlevel%

call :build -O0 -std=c++14 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
call :build -O0 -pedantic-errors -std=c++14
if not %errorlevel% == 0 exit /b %errorlevel%

call :build -O3 -std=c++14 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
...
call :build -Os -fsanitize=undefined -fsanitize-undefined-trap-on-error -std=c++14 -D__STRICT_ANSI__=1 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
call :build -Os -fsanitize=undefined -fsanitize-undefined-trap-on-error -pedantic-errors -std=c++14 -D__STRICT_ANSI__=1
if not %errorlevel% == 0 exit /b %errorlevel%

call :build -O0 -std=c++14 -D__STRICT_ANSI__=1 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
call :build -O0 -pedantic-errors -std=c++14 -D__STRICT_ANSI__=1
if not %errorlevel% == 0 exit /b %errorlevel%

call :build -O3 -std=c++14 -D__STRICT_ANSI__=1 -DCKD_FORCE_IN128=1
if not %errorlevel% == 0 exit /b %errorlevel%
