...
set comp=clang.exe -isystem . -Weverything -Wno-declaration-after-statement -Wno-unsafe-buffer-usage -Wno-pre-c11-compat%CLANG_EXTRA_FLAGS% -Werror -Wfatal-errors -D_CRT_SECURE_NO_WARNINGS=1 -o test.exe
...
set comp=clang++.exe -isystem . -Weverything -Wno-unsafe-buffer-usage -Wno-c++98-compat -Wno-c++98-compat-pedantic%CLANG_EXTRA_FLAGS% -Werror -Wfatal-errors -D_CRT_SECURE_NO_WARNINGS=1 -o test.exe -x c++
